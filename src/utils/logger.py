...
# NEW FUNCTION: Reads the historical CSV data
def load_historical_data_for_endpoint(lsr_data: Dict) -> pd.DataFrame:
    """Loads historical latency data for a specific endpoint from the CSV."""
    ...
    # Filter the DataFrame to include ONLY the rows for the current endpoint
    return df[df['endpoint_id'] == endpoint_id]